...
public class BuildVars {
    ...
    public static String BUILD_VERSION_STRING = "1";
    ...
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.blackzafiqz.telegram";
